    ...
    <>
      <Transition appear show={isOpen} as={Fragment}>
        <Dialog as="div" className="relative z-10" onClose={closeModal}>
          ...
          >
            <Dialog.Panel 
              className="relative w-full max-w-lg max-h=[98vh] overflow-y-auto transform rounded-2xl bg-white p-6 text-left shadow-xl transmition-all flex flex-col gap-5">
              <button
                type='button'
